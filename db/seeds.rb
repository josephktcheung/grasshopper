...
Apprenticeship.create(master: User.find_by(id: 3), apprentice: User.find_by(id: 2), end_date: (2.month.from_now))
Rating.create(rater: User.find_by(id: 1), ratee: User.find_by(id: 2), apprenticeship: Apprenticeship.find_by(id: 1), rating: 5)
Rating.create(rater: User.find_by(id: 2), ratee: User.find_by(id: 1), apprenticeship: Apprenticeship.find_by(id: 1), rating: 3)
