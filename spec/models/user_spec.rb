...
# apprenticeship tests
  ...
  describe "Role" do
    ...
    it "should be valid with a role"
  end
  ...
  describe "status" do
    it "should be active when user starts and apprenticeship"
  ...
  describe "rated_by" do
    it "should change the score when the user is rated"
  end
  ...
  describe "score" do
    it "should not be valid without a score"
  end
end